#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Date    : 2018-06-12 12:39:20
# @Author  : 243825348 (you@example.org)
# @Link    : http://example.org
# @Version : $Id$

# 统计微信好友的昵称，备注，签名，性别，地区
...
file.save(aaa)
itchat.send(u'这是您的好友统计','filehelper')
itchat.send('@%s@%s' % ('fil',aaa), 'filehelper')
# itchat.send('@%s@%s' % ('fil',aaa), toUserName=itchat.search_friends(name=u'@cium')[0]['UserName'])
print ("over")
